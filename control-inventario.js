...
function calcularValorParte(parte) {
    // IMPLEMENTADO: Calcula el valor monetario total multiplicando cantidad * precio_unitario
    // Concepto: Variables numéricas y operador de multiplicación (Unidad 1-2)
...
function calcularTotalInventario(listado) {
    // IMPLEMENTADO: Recorre el arreglo de partes y acumula la suma de valores individuales
    // Concepto: Recorrido de arreglos (Unidad 3) usando bucle for y acumulación
    var acumulador = 0;
    for (var i = 0; i < listado.length; i++) {
        acumulador = acumulador + calcularValorParte(listado[i]);
    }
    return acumulador;
}
...
function registrarEntrada(idParte, cantidad) {
    ...
    // IMPLEMENTADO: Valida que no exceda capacidad_maxima antes de modificar
    // Concepto: Operador de suma y condicional (Unidad 1)
...
function registrarSalida(idParte, cantidad) {
    ...
    // IMPLEMENTADO: Verifica stock suficiente antes de descontar
    // Concepto: Condicional, operador de resta y tipo Boolean (Unidad 1-2)
...
function calcularPorcentajeOcupacion(parte) {
    // IMPLEMENTADO: Calcula porcentaje dividiendo cantidad / capacidad_maxima * 100
    // Concepto: Operadores de división y multiplicación (Unidad 2)
...
function verificarStockMinimo(parte) {
    // IMPLEMENTADO: Retorna Boolean comparando cantidad <= cantidad_minima
    // Concepto: Operadores de comparación y tipo Boolean (Unidad 2)
